...
const App: React.FC = () => {
  ...
  const testimonials = [
    { 
      name: "Alex M.", 
      loc: "Park Slope", 
      content: "Our backyard was a mess for years. Verdan fixed everything and now we actually use the space. Highly recommend.",
    ...
    { 
      name: "Marcus L.", 
      loc: "Red Hook", 
      content: "Property value instantly improved. Tenants noticed immediately. Verdan handles the maintenance so I don't have to.",
    ...
    { 
      ...
      content: "We have very narrow access to our garden. Most companies turned us down, but Verdan handled it like pros. Zero damage, 100% satisfaction.",
  ...
  return (
    <div className="min-h-screen selection:bg-emerald-100 selection:text-emerald-900 relative">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="bg-emerald-50 rounded-[48px] p-8 md:p-16 border border-emerald-100 flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="text-center md:text-left">
                <h3 className="text-2xl md:text-4xl font-bold text-slate-900 mb-4 tracking-tight">The Verdan Peace-of-Mind Guarantee</h3>
      ...
      <button 
        ...
        className={`fixed bottom-24 right-6 md:bottom-10 md:right-10 z-50 p-4 bg-white border border-slate-100 text-emerald-600 rounded-full shadow-2xl transition-all duration-500 ${
